...
class ActiveTrackerView extends StatefulWidget {
  const ActiveTrackerView({super.key});

  @override
  State<ActiveTrackerView> createState() => _ActiveTrackerViewState();
}

class _ActiveTrackerViewState extends State<ActiveTrackerView> {
  @override
  int touchedIndex = -1;
                ...
                child: BarChart(BarChartData(
                  barTouchData: BarTouchData(
                    touchTooltipData: BarTouchTooltipData(
                      tooltipBgColor: Tcolo.gray,
                      fitInsideHorizontally: true,
                      // getTooltipColor: (groub) => Tcolo.gray,
                      // tooltipHorizontalAlignment: .right,
                      tooltipMargin: 10,
  ...
  List<BarChartGroupData> showingGroups() => List.generate(7, (i) {
        switch (i) {
          case 0:
            return makeGroupData(0, 5, Tcolo.primary,
                isTouched: i == touchedIndex);
          case 1:
            return makeGroupData(1, 10.5, Tcolo.scandy,
                isTouched: i == touchedIndex);
          case 2:
            return makeGroupData(2, 5, Tcolo.primary,
                isTouched: i == touchedIndex);
          case 3:
            return makeGroupData(3, 7.5, Tcolo.scandy,
                isTouched: i == touchedIndex);
          case 4:
            return makeGroupData(4, 15, Tcolo.primary,
                isTouched: i == touchedIndex);
          case 5:
            return makeGroupData(5, 5.5, Tcolo.scandy,
                isTouched: i == touchedIndex);
          case 6:
            return makeGroupData(6, 8.5, Tcolo.primary,
                isTouched: i == touchedIndex);
          default:
            return throw Error();
        }
