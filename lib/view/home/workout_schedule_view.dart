...
class WorkoutScheduleView extends StatefulWidget {
  final Map dObj;
  const WorkoutScheduleView({super.key, required this.dObj});
      ...
      body: Column(
        ...
        children: [
          CalendarAgenda(
            ...
            calendarEventSelectedColor: Colors.grey.withOpacity(0.15),
              ...
              child: SizedBox(
                ...
                child: ListView.separated(
                    ...
                    separatorBuilder: (context, index) {
                      return Divider(
                        color: Tcolo.gray.withOpacity(0.2),
                        height: 1,
                      );
                    },
                    itemCount: 24),
