...
class ShowViewVideoOne extends StatefulWidget {
  final String video;

  const ShowViewVideoOne({
    super.key,
    required this.video,
  });

  @override
  State<ShowViewVideoOne> createState() => _ShowViewVideoOneState();
}
...
String id = 'wm47Swzn_98';

class _ShowViewVideoOneState extends State<ShowViewVideoOne> {
